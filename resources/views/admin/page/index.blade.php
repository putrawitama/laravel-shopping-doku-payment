...
<body>
    ...
    <script src="{{ URL::to('src/jquery.cookie/jquery.cookie.js') }}"> </script>
    <script src="{{ URL::to('src/js/grasp_mobile_progress_circle-1.0.0.min.js') }}"></script>
    <script src="{{ URL::to('src/jquery-validation/jquery.validate.min.js') }}"></script>
    <script src="{{ URL::to('src/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script>
    <script src="{{ URL::to('src/js/charts-home.js') }}"></script>
    <script src="{{ URL::to('src/js/front.js') }}"></script>
</body>
</html>